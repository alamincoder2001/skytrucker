    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" href="{{ route('data.list') }}">
                ...
                <a class="nav-link" href="{{ route('picture.list') }}">
                ...
                <a class="nav-link" href="{{ route('gaming.list') }}">
                    <div class="sb-nav-link-icon"><i class="fas fa-list"></i></div>
                    BL Gaming Record
                </a>
                @endif
                ...
                @if(in_array('reports.areawise datalist', $access) ||
                in_array('reports.leaderwise datalist', $access) || in_array('reports.bpwise datalist', $access))
                ...
                <div class="collapse" id="collapsereport" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        @if(in_array('reports.areawise datalist', $access))
                        <a class="nav-link" href="{{ route('data.areawisedataList') }}">Area Wise Data</a>
                        @endif
                        @if(in_array('reports.leaderwise datalist', $access))
                        <a class="nav-link" href="{{ route('data.teamleaderwisedataList') }}">Team-Leader Wise Data</a>
                        @endif
                        @if(in_array('reports.bpwise datalist', $access))
                        <a class="nav-link" href="{{ route('data.bpwisedataList') }}">BP Wise Data</a>
                        @endif
                    </nav>
                </div>
                @endif
